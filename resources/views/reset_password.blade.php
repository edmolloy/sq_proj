...
It passes information via a post method to the ResetPasswordController, invisible from the URL.

JavaScript handles errors before the information is passed. Should there be an error (i.e. old password is incorrect)
then the ChangePasswordController will return a session failure, and Javascript will also display that the attepmt
